...
-- Run as superuser (postgres) to create the database and schema

-- Create database if it doesn't exist
CREATE DATABASE saham_db OWNER localuser;

-- Grant privileges to localuser
GRANT ALL PRIVILEGES ON DATABASE saham_db TO localuser;
...
-- Give user permissions on schema
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL ON TABLES TO localuser;
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL ON SEQUENCES TO localuser;
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL ON FUNCTIONS TO localuser;
...
-- Grant all permissions to localuser on new objects
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO localuser;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO localuser;
GRANT ALL PRIVILEGES ON ALL FUNCTIONS IN SCHEMA public TO localuser;
